// Funkcja konwertująca sekundy na format h:m:s
...
// Funkcja kopiująca tekst do schowka bez alertu
    ...
    `;
        ...
        button.addEventListener("click", () => {
            ...
            if (video) {
                ...
                // Odejmujemy 4 sekundy, zapewniając, że czas nie jest ujemny
        ...
        // Dodajemy przycisk na końcu lewych kontrolek
        videoPlayer.appendChild(button);
    }
}

// Obserwator zmian DOM, by upewnić się, że przycisk zostanie dodany nawet po zmianie strony
...
// Wywołaj dodanie przycisku przy ładowaniu strony
addButton();
